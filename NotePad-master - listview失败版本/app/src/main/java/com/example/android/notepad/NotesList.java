...
//        setDefaultKeyMode(DEFAULT_KEYS_SHORTCUT);
        ...
        while (cursor.moveToNext()) {
            title[flag] = cursor.getString(cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_TITLE));
            time[flag] = sdf.format(cursor.getLong(cursor.getColumnIndex(NotePad.Notes.COLUMN_NAME_MODIFICATION_DATE)));
            flag++;
        ...
        //创建一个SimpleAdapter
        SimpleAdapter simpleAdapter = new SimpleAdapter(this, listitems, R.layout.noteslist_item,
